...
class FdrTranscriptCommandTests(unittest.TestCase):
...
class TranscriptEnv:
    def __init__(self, root: Path) -> None:
        ...
        self.memory_file = root / "fdr-v1-agent" / "data" / "memory" / "fdr_memory.jsonl"
...
def _test_app(root: Path):
    ...
    memory_file = root / "fdr-v1-agent" / "data" / "memory" / "fdr_memory.jsonl"
    settings = settings.__class__(
        **{
            **settings.__dict__,
            "memory_file": memory_file,
            "conversations_dir": root / "fdr-v1-agent" / "data" / "conversations",
            "web_cache_dir": root / "fdr-v1-agent" / "data" / "web_cache",
            "source_docs_dir": root / "fdr-v1-agent" / "data" / "source_docs",
            "external_source_docs_dir": root / "fdr-v1-agent" / "data" / "source_docs",
            "vector_store_dir": root / "fdr-v1-agent" / "data" / "vector_store",
        }
    )
