...
def retrieve(
    ...
    message = (
        ...
        else "Insufficient evidence in the indexed documents. FDR should not answer this from the docs."
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Retrieve relevant chunks from FDR's vector store.")
