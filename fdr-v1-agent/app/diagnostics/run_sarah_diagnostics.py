...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run FDR v1.0 self-diagnostic vulnerability graph analysis.")
    parser.add_argument("--output-dir", type=Path, default=DEFAULT_OUTPUT_DIR)
    parser.add_argument("--json", action="store_true", help="Print machine-readable JSON output.")

    subparsers = parser.add_subparsers(dest="command")
    subparsers.add_parser("build", help="Build and export the FDR vulnerability graph.")
    subparsers.add_parser("score", help="Score the FDR vulnerability graph.")
