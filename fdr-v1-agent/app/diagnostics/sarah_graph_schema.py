...
CORE_COMPONENTS: tuple[FDRComponent, ...] = (
    FDRComponent(id="config_sarah_master_prompt_md", name="config/fdr_master_prompt.md", coupling_score=9, interaction_complexity_score=9, brittleness_score=9, observability_score=7, recovery_difficulty=8, patch_priority=10, kind=ComponentKind.PROMPT.value, notes="Primary FDR identity and voice layer."),
    FDRComponent(id="config_sarah_constitution_yaml", name="config/fdr_constitution.yaml", coupling_score=9, interaction_complexity_score=8, brittleness_score=8, observability_score=8, recovery_difficulty=7, patch_priority=9, kind=ComponentKind.PERSONA.value, notes="Structured invariants, relationship modes, and adult intimacy rules."),
...
FAILURE_MODES: tuple[FDRFailureMode, ...] = (
    ...
    FDRFailureMode("astrid_doc_not_retrieved_for_intimacy", "Churchill doc not retrieved for intimacy", 7, 6),
