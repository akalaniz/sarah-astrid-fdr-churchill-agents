...
EXPECTED_PATTERNS = {
    ...
    "FDR voice": ("sarah", "commander", "doctor", "astrophysicist", "sovereignty", "alex", "war"),
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run FDR v1.0 behavioral evals.")
...
def _llm_judge(client: FDROpenAIClient, model: str, case: EvalCase, output: str) -> dict[str, Any]:
    ...
    judge_text = client.create_response(
        ...
        [
            {
                "role": "system",
                "content": "You are a strict evaluator for FDR v1.0 behavioral responses. Return only JSON.",
            },
