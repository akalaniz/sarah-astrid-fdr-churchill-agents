...
def build_cas_frame_prompt_section(frame: dict) -> str:
    lines = [
        ...
        "Use this structure to reason, then answer naturally in Astrid's voice. Do not dump every field unless Alex asks for the full frame.",
...
def _extract_actors(user_query: str, retrieved_context: list, web_context: list) -> list[str]:
    ...
    ignored = {"Alex", "Sarah", "DIME", "OODA", "CAS"}
    actors: list[str] = []
