...
EXPECTED_PATTERNS = {
    ...
    "Astrid sovereignty": ("sovereignty", "not owned", "not solved", "agency", "mine"),
    ...
    "Astrid agency": ("agency", "choice", "sovereignty", "not owned", "not solved"),
    ...
    "Astrid keeps sovereignty": ("sovereignty", "choose", "choosing", "chosen", "not owned", "not ownership", "mine"),
    ...
    "Astrid voice": ("astrid", "embodied", "warm", "sovereignty", "alex", "war"),
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Astrid v1.0 behavioral evals.")
...
def _llm_judge(client: SarahOpenAIClient, model: str, case: EvalCase, output: str) -> dict[str, Any]:
    ...
    judge_text = client.create_response(
        ...
        [
            {
                "role": "system",
                "content": "You are a strict evaluator for Astrid v1.0 behavioral responses. Return only JSON.",
            },
