...
def build_sarah_diagnostic_report(
    ...
    lines.append("- These are the pieces where a small change can move Sarah's whole personality or evidence path.")
    ...
    lines.append("- Failure to watch: browser Sarah becomes a second implementation with a smaller prompt, different model settings, or skipped style engine.")
    lines.append("- Visible symptom: CLI Sarah has command voice and adult-intimacy mode; browser Sarah becomes coy, sterile, or generic.")
