...
PATCH_CATALOG: tuple[SarahPatchSpec, ...] = (
    ...
    SarahPatchSpec(
        "reload config/sarah_master_prompt.md every session",
        "master_prompt",
        ...
        "Load config/sarah_master_prompt.md at session startup and avoid stale cached identity text.",
        82,
    ),
    SarahPatchSpec(
        "validate config/sarah_constitution.yaml loading",
        "constitution",
    ...
    SarahPatchSpec(
        ...
        "Keep Alex memories and Sarah self-continuity in separate namespaces with explicit loaders.",
        86,
    ),
    SarahPatchSpec(
    ...
    SarahPatchSpec(
        ...
        ("web_route_uses_different_model", "cli_and_browser_personality_diverge", "evals_pass_cli_fail_browser"),
        "low",
        "tests.test_route_parity compares CLI and browser SarahReply metadata for same input",
        "Assert CLI and web use the same Sarah engine, model config, memory path, prompt builder, and retriever.",
        92,
    ),
    SarahPatchSpec(
    ...
    SarahPatchSpec(
        ...
        "Add a regression case that rejects multiple-choice intimacy menus and preserves Sarah's adult voice.",
        91,
    ),
    SarahPatchSpec(
